...
Alternativamente, para disminuir el tamaño del prototipo, se reemplaza la fuente de alimentación del sistema. Se opta por utilizar un \textit{Power Bank} (batería externa portátil) que cumpla con los requisitos de tensión y corriente necesarios. 

Las razones por las cuales se decidió utilizar dicha tecnología como reemplazo es porque posee alta portabilidad, un tamaño reducido, es independiente de la red eléctrica, brinda la señal de alimentación estable y es fácilmente recargable. El dispositivo elegido para esta tarea es el cargador \href{https://www.sony.com/electronics/support/res/manuals/W000/W0002536M.pdf}{CP-V3} de la empresa \textit{Sony}.
