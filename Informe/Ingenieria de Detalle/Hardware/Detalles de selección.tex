...
Por lo que, por un lado, teniendo en cuenta que la batería, de $V_{bat} = 12 \ V$, debe tener una capacidad de almacenamiento equivalente a $T_{reserva} = 4 \ d\acute{\imath}as$ sin recarga \lnote{estadistica del lugar pls} y utilizando un coeficiente de seguridad de $\gamma_{bat} = 1.5$, se obtiene
