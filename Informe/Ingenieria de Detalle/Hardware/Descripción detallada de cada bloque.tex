...
El bloque del cargador consiste en el transmisor y un receptor de potencia. La sección ocupada de la transmisión inalámbrica consta de un oscilador de $915 \ MHz$, el cual está comandado por la R-Pi, y un amplificador de potencia alimentado por otra etapa DC-DC de 12 V a 15 V.

Por el lado del receptor, se encuentra el integrado P1110B, el cual estabiliza la energía para proveer realizar la carga de al UBM.
