...
%Con estas salidas se alimentan todos los módulos, a excepción del oscilador de potencia. Este módulo necesita una etapa DC-DC la cual eleva la tensión. Para ello se emplea una fuente \textit{switching} de topología \textit{Boost}.
...
Por fuera del \textit{shield}, la Raspberry Pi cuenta tanto con un conector destinado al uso de una cámara como uno conector mini USB por el cual se energiza la unidad. Ambos conectores se muestran en la Figura (\ref{fig:rpiFront}).
\begin{figure}[H]
	\centering
