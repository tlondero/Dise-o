...
\textbf{Precisión [°C]}                                                       & $\pm$ 1.5	& $\pm$ 0.1	& $\pm$ 0.5	& $\pm$ 0.5	\\ \hline
...
Existen varias maneras de medir la magnitud física de la humedad, dentro de estas la más común se basa en utilizar la dependencia que existe entre la humedad y la capacidad. Es por esto que se utilizan capacitores con un dieléctrico, el cual cambia constante con la humedad. Además, existen sensores que se aprovechan de cómo cambia la resistencia en función de la temperatura, pero estas tecnologías son menos frecuentes.
...
\textbf{Precisión [\%RH]}                                                       & $\pm$4	& $\pm$3	 & $\pm$2	& $\pm$5	\\ \hline
...
Es fundamental contar con un m\'etodo para conocer la fecha y hora de manera confiable. Tanto como para saber en qué momento fueron tomadas las mediciones. Teniendo esto en cuenta se proponen los siguientes módulos RTC:
\begin{table}[H]
\centering
...
\end{tabular}
\caption{Comparación entre módulos RTC.}
\label{comp:Rtc}
\end{table}

\Subsubsubsection{Presencia}
Se desea conocer cuándo está presente el ave dentro del nido. Para esto, se decide utilizar BLE por su baja utilización de recursos energéticos. Una opción es utilizar la \rpi como receptora. Otras opciones que se exploran involucran utilizar un transceptor\footnote{Un tranceptor es aquel cuyo se encuentra compuesto con un transmisor y un receptor, compartiendo circuito y/o encapsulado.} \textit{Bluetooth}.
...
\textbf{\begin{tabular}[c]{@{}c@{}}Aspectos\\ comparativos\end{tabular}} &
  ...
  \textbf{\textbf{\href{https://www.espressif.com/sites/default/files/documentation/esp32-s3-wroom-1_wroom-1u_datasheet_en.pdf}{ESP32-S3-WROOM-1-N4}}} \\ \hline
\textbf{Costo [USD]} &
  - &
  3 &
  10.77 &
