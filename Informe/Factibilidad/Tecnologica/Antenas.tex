La solución planteada para el análisis de la factibilidad de la transferencia de energía al dispositivo del ave es por medio de radiación electromagnética. A continuación se detallará el análisis realizado y las conclusiones tomadas.
