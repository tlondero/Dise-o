...
\item Esta frecuencia pertenece a la banda ISM, la cual está reservada para propósitos industriales, científicos o médicos, excluyendo las aplicaciones de telecomunicaciones\cite{ref:ITUISM}, limitadas a la Región 2 definida por la ITU como las Américas\cite{ref:ITUREGION}.
\end{itemize}
