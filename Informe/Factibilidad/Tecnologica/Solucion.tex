...
De esta forma, para alimentar tanto a los sensores como a la R-Pi y al sistema de carga inalámbrica en un día se requieren $259.2 \ kJ$. Con una batería de $36 \ Ah$ de capacidad se consigue la especificación mencionada, por lo que se opta usar una batería de la serie JDG de Kijo.

\Subsubsubsection{Alimentación}

Para poder abastecer a la batería seleccionada, con un panel $25.2 \ W$ se puede proveer la potencia requerida.
