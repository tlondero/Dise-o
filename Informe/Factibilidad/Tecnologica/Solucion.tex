...
Para la detección de presencia se descarta el uso de la \rpi 3B dado que esta debe estar por fuera del nido al no haber suficiente espacio en la bóveda. El módulo NRF24L01 por no ser compatible con \textit{Bluetooth} 5.0 se descarta y finalmente se decide utilizar el ESP32-S3-WROOM-1 por el menor costo y mayor sensibilidad de recepción de la antena.
