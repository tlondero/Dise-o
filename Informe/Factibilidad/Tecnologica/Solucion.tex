...
%%%%%%IAMGENES%%%%%%
Finalmente, para la cámara que obtendrá las imágenes y el video, se valoró la relación precio-resolución de la cámara, al igual que la integración con Linux, aunque el factor que mas contribuyó a la elección fue que la cámara elegida tenga la capacidad de funcionar incluso en malas condiciones de iluminación, dado que dentro del nido del carpintero hay un nivel de luz bajo. Por estos factores se optó por utilizar la RPi NoIR V2.
