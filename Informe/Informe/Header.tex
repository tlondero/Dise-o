...
% #1 = size, #2 = text
\newcommand{\setparagraphsize}[2]{{\fontsize{#1}{6}\selectfont#2 \par}}
\newcommand{\setlinesize}[2]{{\fontsize{#1}{6}\selectfont#2}}
\newcommand{\litnote}[1]{{\fontsize{20}{6}\selectfont\textcolor{green}{#1}}}

\usepackage{fontspec}	%Compilar en XeLaTex o LuaLatexTuve y si sigue sin andar
%comentar \usepackage[utf8]{inputenc} 
