...
\addto\captionsspanish{
	\renewcommand\contentsname{\large \arabic{section}.\arabic{subsection}.\hspace{5mm}Contenidos}
	\renewcommand\listfigurename{\large \arabic{section}.\arabic{subsection}.\hspace{5mm}Lista de Figuras}
	\renewcommand\listtablename{\large \arabic{section}.\arabic{subsection}.\hspace{5mm}Lista de Tablas}
}
...
\newcommand{\MyIndex}{
	...
	\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}\textbf{Contenidos}}
	\tableofcontents

	%Agrega LOF al indice
	\stepcounter{subsection}
	\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}\textbf{Lista de Figuras}}
	\listoffigures

	%Agrega LOT al indice
	\stepcounter{subsection}
	\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}\textbf{Lista de Tablas}}
	\listoftables
}
