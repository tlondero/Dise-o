...
\newcommand{\MyIndex}{
	...
	\tableofcontents\thispagestyle{fancy}\protect

	%Agrega LOF al indice
	\stepcounter{subsection}
	\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}{Lista de Figuras}}
	\listoffigures\thispagestyle{fancy}\protect

	%Agrega LOT al indice
	\stepcounter{subsection}
	\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}{Lista de Tablas}}
	\listoftables\thispagestyle{fancy}\protect
}

%Indices: cambio la separación de los numeros para que entren tablas y fotos
\usepackage{tocloft}
\setlength{\cftfignumwidth}{1.55cm}  % change numwidth from figures in lof
\setlength{\cfttabnumwidth}{1.55cm}  % change numwidth from tables in lot
