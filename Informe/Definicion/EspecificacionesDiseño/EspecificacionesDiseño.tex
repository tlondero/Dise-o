...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                  & \textbf{Origen}                       & \multicolumn{1}{l|}{\textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}}} \\ \hline
INT-MEC-01  & El equipo deberá poder sujetarse con (TBD) tornillos tipo (TBD) distanciados entre sí (TBD)                                           & {\color[HTML]{000000} REQ-01, REQ-10} & F - I D                                                                                          \\ \hline
INT-MEC-02  & \begin{tabular}[c]{@{}l@{}}El sistema de montaje de la unidad de energía deberá ser capaz\\ de soportar un peso de (TBD)\end{tabular} & {\color[HTML]{000000} REQ-01, REQ-10} & F - D T                                                                                          \\ \hline
\end{tabular}
...
INT-COM1-01 & \begin{tabular}[c]{@{}l@{}}La transmisión de datos desde el ave al nido debe poder ser\\ interrumpida en cualquier momento sin pérdidas de información\\ considerables.\end{tabular}                                                        & {\color[HTML]{000000} REQ-05, REQ-16} & P F - I D T                                                                 \\ \hline
INT-COM1-02 & \begin{tabular}[c]{@{}l@{}}La transmisión de datos deberá tener un alcance\\ mínimo de 50cm.\end{tabular}                                                                                                                                   & {\color[HTML]{000000} REQ-05}         & P F - I D T                                                                 \\ \hline
INT-COM1-03 & \begin{tabular}[c]{@{}l@{}}La transmisión de datos deberá comenzar de manera automática\\ en cuanto el dispositivo del ave se encuentre dentro del alcance y con \\ el nivel de carga suficiente para sostener la transmisión.\end{tabular} & {\color[HTML]{000000} REQ-05, REQ-16} & P F - I D T                                                                 \\ \hline
INT-COM1-04 & La transmisión de datos deberá efectuarse por medio del protocolo TBD.                                                                                                                                                                      & {\color[HTML]{000000} REQ-05}         & P F - I D T                                                                 \\ \hline
\end{tabular}
...
INT-COM2-03 & La transmisión de datos deberá ser inicializada por la persona.                                                                                                                                                                                                                              & REQ-07          & P F - I D T                                                                 \\ \hline
INT-COM2-04 & La transmisión de datos deberá efectuarse por medio del protocolo TBD.                                                                                                                                                                                                                       & REQ-07          & P F - I D T                                                                 \\ \hline
...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                                                    & \textbf{Origen}                                               & \textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
PER-01      & \begin{tabular}[c]{@{}l@{}}El equipo deberá realizar la carga de la batería del ave con una \\ eficiencia no menor al TBD\%.\end{tabular}                               & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-15}         & P F - D T                                                                   \\ \hline
PER-02      & \begin{tabular}[c]{@{}l@{}}El equipo no deberá consumir más de TBD Watts mientras no se \\ esté recargando al dispositivo del ave ni transmitiendo datos.\end{tabular}  & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-02}         & P F - D T                                                                   \\ \hline
PER-03      & \begin{tabular}[c]{@{}l@{}}El equipo no deberá consumir más de TBD Watts mientras se está \\ recargando al dispositivo del ave y recibiendo datos de este.\end{tabular} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-02, REQ-15} & P F - D T                                                                   \\ \hline
PER-04      & \begin{tabular}[c]{@{}l@{}}El equipo no deberá consumir más de TBD Watts mientras se está \\ transmitiendo datos al dispositivo de la persona.\end{tabular}             & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-02, REQ-7}  & P F - D T                                                                   \\ \hline
\end{tabular}
...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                                                                    & \textbf{Origen}                                               & \textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
IMP-DIM-01  & \begin{tabular}[c]{@{}l@{}}El dispositivo del nido no deberá exceder las siguientes dimensiones\\ Largo \textless 26 cm\\ Ancho \textless 8,79 cm\\ Alto \textless 4,55 cm\end{tabular} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-01}         & P F - I D                                                                   \\ \hline
IMP-DIM-02  & \begin{tabular}[c]{@{}l@{}}La unidad de energía no deberá exceder las siguientes dimensiones\\ Largo \textless TBD\\ Ancho \textless TBD\\ Alto \textless TBD\end{tabular}              & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-01, REQ-09} & P F - I D                                                                   \\ \hline
IMP-DIM-03  & El equipo dentro del nido no deberá exceder los TBD gramos.                                                                                                                             & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-01, REQ-09} & P F - I D                                                                   \\ \hline
IMP-DIM-04  & La unidad de energía no deberá exceder los TBD kilos.                                                                                                                                   & \cellcolor[HTML]{FFFFFF}{\color[HTML]{000000} REQ-01, REQ-09} & P F - I D                                                                   \\ \hline
\end{tabular}
...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                    & \textbf{Origen}               & \textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
IMP-COS-01  & \begin{tabular}[c]{@{}l@{}}La suma del costo de las partes que conforman al producto no \\ deberá ser superior a TBD USD.\end{tabular}  & {\color[HTML]{000000} REQ-11} & F - D                                                                       \\ \hline
IMP-COS-02  & \begin{tabular}[c]{@{}l@{}}La suma del costo de las partes que conforman el prototipo no \\ deberá ser superior a TBD USD.\end{tabular} & {\color[HTML]{000000} REQ-11} & P - D                                                                       \\ \hline
\end{tabular}
...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                                        & \textbf{Origen}               & \textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
IMP-EMC-01  & \begin{tabular}[c]{@{}l@{}}El dispositivo deberá poder operar normalmente con inmunidad al \\ ruido electromagnético de acuerdo a la norma TBD\end{tabular} & {\color[HTML]{000000} REQ-13} & F - D T                                                                     \\ \hline
\end{tabular}
...
\hline
\textbf{ID} & \textbf{Descripción}                                                                                                                                            & \textbf{Origen}                       & \textbf{\begin{tabular}[c]{@{}l@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
RAM-SEG-01  & La máxima temperatura que podrá tener la carcasa será de TBD C°                                                                                                 & {\color[HTML]{000000} REQ-12, REQ-16} & P F - I D T(TBD)                                                            \\ \hline
...
RAM-SEG-03  & \begin{tabular}[c]{@{}l@{}}El dispositivo contará con un sistema de autenticación ante el pedido de \\ transmisión de datos definido por INT-COM2.\end{tabular} & {\color[HTML]{000000} REQ-07}         & P F - I D T(TBD)                                                            \\ \hline
RAM-SEG-04  & (TBD) según la norma (TBD): seguridad ambiental.                                                                                                                & {\color[HTML]{000000} REQ-14}         &                                                                             \\ \hline
RAM-SEG-05  & (TBD) según la norma (TBD): seguridad eléctrica.                                                                                                                & {\color[HTML]{000000} REQ-12}         &                                                                             \\ \hline
\end{tabular}
