...
\textbf{INT-FUN-03} &
  ...
  P F - I D T \\ \hline
\textbf{INT-FUN-04} &
  \begin{tabular}[c]{@{}c@{}}El producto debe ser capaz de obtener\\ la intensidad lumínica del interior del nido.\end{tabular} &
  REQ-04 &
  P F - I D T \\ \hline
\textbf{INT-FUN-05} &
...
\textbf{INT-FUN-06} &
  ...
  P F - I D T \\ \hline
\textbf{INT-FUN-07} &
  \begin{tabular}[c]{@{}c@{}}El producto debe ser capaz de detectar\\ la presencia del ave en el nido.\end{tabular} &
  REQ-04 &
  P F - I D T \\ \hline
\textbf{INT-FUN-08} &
...
\textbf{INT-FUN-14} &
  ...
  P F - I D T \\ \hline
\textbf{INT-FUN-15} &
  \begin{tabular}[c]{@{}c@{}}El sistema deberá poder obtener\\ imágenes entre 5 minutos y 60 minutos.\end{tabular} &
  REQ-04 &
  P F - I D T \\ \hline
\textbf{INT-FUN-16} &
...
\textbf{INT-COM2-01}                       & \begin{tabular}[c]{@{}c@{}}La transmisión de datos desde el nido hacia una\\ persona deberá ser del tipo flush, descargándose\\ al dispositivo de la persona todos los datos\\ almacenados en el nido, liberando a la vez todo\\ el espacio de almacenamiento de datos del nido.\end{tabular} & REQ-07                               & P F - I D T                                                                 \\ \hline
\textbf{INT-COM2-02}                       & \begin{tabular}[c]{@{}c@{}}La transmisión de datos deberá tener un alcance\\ 15 a 20 metros.\end{tabular}                                                                                                                                                                                     & REQ-07                               & P F - I D T                                                                 \\ \hline
\textbf{INT-COM2-03}                       & \begin{tabular}[c]{@{}c@{}}La transmisión de datos será\\ inicializada en las horas diurnas.\end{tabular}                                                                                                                                                                      & REQ-07                               & P F - I D T                                                                 \\ \hline
\textbf{INT-COM2-04}                       & \begin{tabular}[c]{@{}c@{}}La transmisión de datos deberá efectuarse por\\ medio del protocolo WiFi.\end{tabular}                                                                                                                                                                             & REQ-07                               & P F - I D T                                                                 \\ \hline
\textbf{INT-COM2-05}                       & \begin{tabular}[c]{@{}c@{}}El descarte de los datos almacenados en el nido\\ sucederá una vez completa la transmisión sin\\ interrupciones prematuras.\end{tabular}                                                                                                                           & REQ-07                               & P F - I D T                                                                 \\ \hline
\textbf{INT-COM2-06}                       & \begin{tabular}[c]{@{}c@{}}Se le indicará a la persona que los datos fueron\\ transmitidos al finalizar dicho proceso.\end{tabular}                                                                                                                                                           & REQ-07                               & P F - I D T                                                                 \\ \hline
\end{tabular}
...
\hline
\multicolumn{1}{|c|}{\textbf{ID}} & \multicolumn{1}{c|}{\textbf{Descripción}}                                                                                                                         		& \multicolumn{1}{c|}{\textbf{Origen}} & \textbf{\begin{tabular}[c]{@{}c@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
\textbf{IMP-DIM-01}                        & \begin{tabular}[c]{@{}c@{}}El dispositivo del nido no deberá exceder las\\ siguientes dimensiones:\\ Largo < 26 cm\\ Ancho < 8,79 cm\\ Alto < 4,55 cm\end{tabular} 			 & REQ-01                              & F - I D T                                                                   \\ \hline
\textbf{IMP-DIM-02}                        & \begin{tabular}[c]{@{}c@{}}La unidad de energía no deberá exceder las\\ siguientes dimensiones:\\ Largo < \TBD \\ Ancho < \TBD \\ Alto < \TBD\end{tabular}                    & REQ-01                       & F - I D T                                                                   \\ \hline
\textbf{IMP-DIM-03}                        & \begin{tabular}[c]{@{}c@{}}El equipo dentro del nido no deberá exceder\\ los \TBD gramos.\end{tabular}                                                             			 & REQ-01                       & F - I D T                                                                   \\ \hline
\textbf{IMP-DIM-04}                        & \begin{tabular}[c]{@{}c@{}}La unidad de energía no deberá exceder\\ los \TBD kilos.\end{tabular}                                                                   			 & REQ-01                       & F - I D T                                                                   \\ \hline
\end{tabular}
...
\textbf{IMP-OPE-01}  & \begin{tabular}[c]{@{}c@{}}El sistema deberá poder operar normalmente cuando la \\ temperatura  ambiente sea -20°C < $\text{T}_{\text{AMB}}$ < 30°C.\end{tabular}                                                                                           & REQ-09                               & F - I D                                                                     \\ \hline
\textbf{IMP-OPE-02}  & \begin{tabular}[c]{@{}c@{}}Deberá poder operar normalmente cuando la humedad\\ sea: 0\% < RH < 100\%.\end{tabular}                                                                                                                                         & REQ-09                               & F - I D                                                                     \\ \hline
\textbf{IMP-OPE-03}  & \begin{tabular}[c]{@{}c@{}}El dispositivo deberá poder operar normalmente cuando\\ la presión atmosférica sea: 84 kPa < $\text{P}_{\text{ATM}}$ < 90 kPa.\\ Esto equivale a 1500 m de altura para el mínimo de\\ presión, y un máximo de 0 m.\end{tabular} & REQ-09                               & F - I D                                                                     \\ \hline
\end{tabular}
...
\hline
\multicolumn{1}{|c|}{\textbf{ID}} & \multicolumn{1}{c|}{\textbf{Descripción}}                                                                                                                                    & \multicolumn{1}{c|}{\textbf{Origen}} & \textbf{\begin{tabular}[c]{@{}c@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
\textbf{IMP-AYT-01}                        & \begin{tabular}[c]{@{}c@{}}No se deberán sufrir daños cuando, estando\\ desenergizado, la temperatura ambiente\\ sea -20°C < $\text{T}_{\text{AMB}}$ < 40°C.\end{tabular}    & REQ-09                               & P F - I D                                                                   \\ \hline
\textbf{IMP-AYT-02}                        & \begin{tabular}[c]{@{}c@{}}No se deberán sufrir daños cuando, estando\\ desenergizado, la humedad\\ sea 0\% < RH < 100\%.\end{tabular}                                       & REQ-09                               & P F - I D                                                              \\ \hline
\textbf{IMP-AYT-03}                        & \begin{tabular}[c]{@{}c@{}}No se deberán sufrir daños cuando, estando\\ desenergizado, la presión atmosférica\\ sea 84 kPa < $\text{P}_{\text{ATM}}$ < 101 kPa.\end{tabular} & REQ-09                               & P F - I D                                                              \\ \hline
\end{tabular}
...
\hline
\multicolumn{1}{|c|}{\textbf{ID}} & \multicolumn{1}{c|}{\textbf{Descripción}                                                                                                                                                                                } & \multicolumn{1}{c|}{\textbf{Origen}}                       & \textbf{\begin{tabular}[c]{@{}c@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
\textbf{RAM-CON-01}  & \begin{tabular}[c]{@{}c@{}}El producto deberá tener una vida útil no\\ menor a 2 años.\end{tabular} & REQ-13          & P F - D                                                                     \\ \hline
\end{tabular}
...
\hline
\multicolumn{1}{|c|}{\textbf{ID}} & \multicolumn{1}{c|}{\textbf{Descripción}}                                                                                                                        & \multicolumn{1}{c|}{\textbf{Origen}} & \textbf{\begin{tabular}[c]{@{}c@{}}Aplicabilidad\\ Validación\end{tabular}} \\ \hline
\textbf{RAM-SEG-01}                        & \begin{tabular}[c]{@{}c@{}}El dispositivo contará con un sistema de autenticación\\ ante el pedido de transmisión de datos definido\\ por INT-COM2.\end{tabular} & REQ-07                               & F - I D T                                                                   \\ \hline
\textbf{RAM-SEG-02}                        & \begin{tabular}[c]{@{}c@{}}El dispositivo no poseerá luces ni elementos reflectantes\\ para no ser percibido.\end{tabular}                                       & REQ-08                               & F - I D T                                                                   \\ \hline
\end{tabular}
