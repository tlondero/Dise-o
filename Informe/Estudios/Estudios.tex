...
\begin{figure}[H]
	...
	\label{fig:criticos}
\end{figure}
Se calcula una estimación de la confiabilidad de cada módulo utilizando una estrategia \quotes{Top-Down} donde se encuentra la tasa de falla de cada sub-módulo mediante un proceso multiplicativo a la tasa de fallos base provista por las distintas cargas a la cual son sometidos los componentes.
