...
Las siguientes validaciones están relacionadas con el manejo apropiado del tiempo. A continuación se presenta la que corresponde a \textit{T-INT-FUN-08}.
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
\centering	\includegraphics[width=0.8\linewidth]{ImagenesValidacion del prototipo/pend}
